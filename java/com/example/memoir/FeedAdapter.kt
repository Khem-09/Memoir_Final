...
class FeedAdapter(private val itemList: List<FeedItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class MemoryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tabLayout: TabLayout = itemView.findViewById(R.id.tabLayoutDots) // The Dots
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (getItemViewType(position) == FeedItem.TYPE_MEMORY) {
            ...
            mHolder.category.text = memory.category.uppercase()
            ...
            if (imageList.isNotEmpty()) {
                ...
                if (imageList.size > 1) {
                    ...
                    // Connect Dots to Slider
                    TabLayoutMediator(mHolder.tabLayout, mHolder.viewPager) { _, _ ->
                        // No text, just dots
                    }.attach()
                } else {
